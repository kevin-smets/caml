 ...
 *     able: 'i am able'
 *
 * will make that ${var.i.able} will be replace by the value 'i am able'
 *
 * @param yamlLines
 */
function replaceVariables(yamlLines) {
  var regexp = /\${(.*)}/g;
  var yamlString = yamlLines.join('\n');
  ...
  if (match) {
    ...
    match.forEach(function (key) {
      ...
      if (value) {
        ...
        console.log("No interpolation value found for " + key + ", nothing was replaced.");
      }
    });
  }
